"""Import glyphs from IBM Plex Mono for Google Fonts Latin Core."""
...
# Google Fonts Latin Core character set (319 codepoints)
# Source: https://github.com/googlefonts/glyphsets/blob/main/data/results/nam/GF_Latin_Core.nam
